...
jQuery(document).ready(function($){
    ...
    function WidthChange(mq) {
        if (mq.matches) {
            $('<div class="jstoggle jstoggle--nav__list" data-toggle="nav__list">Menu</div>').appendTo('.mobile-menu');
            //$(".callus").before('<div class="jstoggle jstoggle--callus" data-toggle="callus">Call</div>');
            $('<div class="jstoggle jstoggle--callus" id="call_button" data-toggle="callus">Call</div>').appendTo('.mobile-menu');
            $(".sub_nav").before('<div class="jstoggle jstoggle--sub_nav jstoggle-close" data-toggle="sub_nav"><i class="fas fa-ellipsis-h"></i></div>');
            $(".callus").hide();
            $(".nav__list").hide();
            $(".sub_nav").hide();
            ...
            $(document).bind('touchstart click', function(e) {
                ...
                if (!$(target).is('.header-sub-nav') && !$(target).parents().is('.header-sub-nav')) {
                    $('.sub_nav').hide();
                    $('.jstoggle--sub_nav').addClass('jstoggle-close');
                }
            });
