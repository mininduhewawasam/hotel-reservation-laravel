            ...
            <div>
                ...
                <form method="post" action="{{ route('getHistory') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <medium id="emailHelp" class="form-text text-muted">{{ $errors->has('historyDate') ? $errors->first('historyDate') : ''}}</medium>
                    </div>
                ...
                {{--                    <div class="row">--}}
                {{--                        <div class="column">--}}
                    {{--                            <img src="{{$SearchResult->propThumbImg}}" onclick="openThumb();showThumb({{0}})" class="hover-shadow"--}}
