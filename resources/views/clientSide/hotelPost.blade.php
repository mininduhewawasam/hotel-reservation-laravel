    ...
    <div class="user_reviews">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="checkIn        Date" value="{{old('checkInDate')}}" class="form-control"
    ...
    <div class="reserve_form">
        ...
        <form method="post" class="reserve_form" action="{{route('reserve_now')}}" >
            ...
            <div class="form-group">
                ...
                <input type="number" name="noOfAdults" value="{{old('noOfAdults')}}" min="1" class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="number" name="noOfChildren" value="{{old('noOfChildren')}}" value min="1" class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="number" name="noOfRooms" value="{{old('noOfRooms')}}" min="1" class="form-control"
